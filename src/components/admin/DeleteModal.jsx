...
const DeleteProductModal = ({ isOpen, onClose, onSubmit }) => {
  ...
  return (
    ...
    >
      <div className="bg-white rounded-lg shadow-lg p-6 w-96 relative">
        ...
        <h2 className="text-lg font-semibold mb-4">Delete a Product</h2>
        ...
        <button
          className="mt-6 w-full bg-red-500 text-white rounded-md p-2 hover:bg-red-600 transition-colors"
